...
function stringProp(instance, key) {
    const value = instance.properties?.[key];
    return typeof value === 'string' ? value : '';
}
export function renderCoreText(instance) {
...
export function renderCoreImage(instance) {
...
export function renderCoreButton(instance, ctx) {
...
export function renderCoreCard(instance, _ctx, children) {
